...
const MediaPostCard: React.FC<{ title: string; subtitle: string }> = ({
  ...
  <div className="bg-gradient-to-br from-blue-50 via-white to-teal-50 shadow rounded-2xl p-6 flex flex-col items-center border border-cyan-100 w-64 min-h-[220px] snap-center shrink-0 hover:scale-105 transition-transform">
