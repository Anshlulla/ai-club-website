...
const AboutCard: React.FC<{ title: string; text: string }> = ({
  ...
  <div className="bg-white shadow-xl rounded-2xl p-6 flex flex-col items-center border border-blue-100 w-72 snap-center shrink-0 hover:scale-105 transition-transform">
