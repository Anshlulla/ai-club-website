...
const EventCard: React.FC<{ title: string; date: string; img: string }> = ({
  title,
  date,
  img,
}) => (
  <div className="bg-gradient-to-br from-white via-blue-50 to-purple-100 shadow-xl rounded-2xl p-6 flex flex-col items-center border border-blue-100 w-80 min-h-[250px] snap-center shrink-0 hover:scale-105 transition-transform">
