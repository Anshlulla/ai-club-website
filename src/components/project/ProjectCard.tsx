...
const ProjectCard: React.FC<{ project: string; img: string }> = ({
  ...
  <div className="bg-gradient-to-br from-indigo-50 via-white to-blue-100 shadow-xl rounded-2xl p-6 flex flex-col items-center border border-indigo-100 w-72 snap-center shrink-0 hover:scale-105 transition-transform">
